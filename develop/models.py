...
class Zoning(models.Model):
    ...
    withdraw_date = models.BigIntegerField(blank=True, null=True, verbose_name="Submitted")
    exp_date_120_days = models.BigIntegerField(blank=True, null=True, verbose_name="Submitted")
    exp_date_2_year = models.BigIntegerField(blank=True, null=True, verbose_name="Submitted")

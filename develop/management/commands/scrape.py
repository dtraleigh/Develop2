...
class Command(BaseCommand):
    def handle(self, *args, **options):
        ...
        if page_response.status_code == 200:
            ...
            # self.site_reviews(page_content, page_link)
            self.zoning_requests(page_content, page_link)
        else:
    ...
    def site_reviews(self, page_content, page_link):
        # Site Reviews
        try:
    ...
    def zoning_requests(self, page_content, page_link):
        # Zoning Requests
        try:
        ...
        for i in range(0, len(zoning_rows), 2):
            ...
            label_a_text = info_row_tds[0].find("a").string
